import gucci from 'gucci'; // eslint-disable-line import/no-extraneous-dependencies

const assert = require('assert');
const { getRandomOddNumberInRange, findSmallestOddNumber } = require('./utils');

gucci.describe('getRandomOddNumberInRange', () => {
  gucci.it('Deve retornar um número ímpar dentro de um range específico.', () => {
...
gucci.describe('findSmallestOddNumber', () => {
  gucci.it('Deve retornar o menor número ímpar de um Array.', () => {
